...
app.post('/postItem', (req, res) => {
  new Promise((resolve, reject) => {
    const result = db.query
      ("INSERT INTO items(cat_id, shop_id, item_name, item_price, item_desc, item_exp_date, item_date_posted, char_id) VALUES($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *",
        [req.body.cat_id, req.body.shop_id, req.body.item_name, req.body.item_price, req.body.item_desc,
          req.body.item_exp_date, req.body.item_date_posted, req.body.char_id]);
